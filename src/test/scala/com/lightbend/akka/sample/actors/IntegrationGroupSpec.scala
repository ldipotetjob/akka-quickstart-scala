...
class IntegrationGroupSpec (_system: ActorSystem)
  ...
  def this() = this(ActorSystem("IntegrationGroupSpec"))

  "IntegrationGroupSpec" should "be able to collect temperatures from all active devices" in {
